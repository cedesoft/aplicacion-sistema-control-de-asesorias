...
public class AdapterSolicitud extends RecyclerView.Adapter<AdapterSolicitud.ItemViewHolder> implements View.OnClickListener {
    List<SolicitudAlumno> solicitud;
    String id, name;
    private View.OnClickListener listener;
    Intent intent;

    public AdapterSolicitud(List<SolicitudAlumno> solicitud) {
    ...
    public void CancelarSolicitud(){
        ...
        apiService.cancelarSolicitud(id).enqueue(new Callback<List<SolicitudAlumno>>() {
            @Override
